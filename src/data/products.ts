...
// `featured` marks the two flagship products the homepage leads with; `menu`
// lists a product in the header Solutions menu.
export const products = [
  {
    key: 'base-registry', name: 'Base Registry Engine', shortName: 'Base Registry Engine', featured: true, menu: true,
  ...
  {
    key: 'protected-registry-apis', name: 'Registry Relay', shortName: 'Relay', featured: false, menu: false,
  ...
  {
    key: 'evidence-gateway', name: 'Evidence Gateway', shortName: 'Evidence', featured: true, menu: true,
  ...
  {
    key: 'casework', name: 'Registry Casework', shortName: 'Casework', featured: false, menu: true,
    intent: 'Coordinate human decisions',
    description: 'Give the officers who review registry changes one accountable inbox: who holds each item, what is due, and who decided.',
